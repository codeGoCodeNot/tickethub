...
const TicketDeletedEmail = ({
  ...
  <Tailwind>
    <Html>
      <Head />
      <Preview>Your ticket "{ticketTitle}" has been removed</Preview>
        ...
        <Container className="bg-white mx-auto max-w-[560px] my-10 rounded-lg overflow-hidden">
          ...
          <Section className="px-8 py-10">
            ...
            <Text className="text-gray-600 text-sm m-0 mb-6">
              Your ticket <span style={{ fontWeight: 600, color: "#111" }}>"{ticketTitle}"</span> in{" "}
              <span style={{ fontWeight: 600, color: "#111" }}>{organizationName}</span> has been
